    ...
    function ($scope, $firebaseObject, $firebaseArray, Ref, Auth) {
        ...
        Auth.$onAuth(function (authData) {
            ...
            if (authData) {
                ...
                var refCart = new Firebase("https://doanungdungweb.firebaseio.com/cart/" + authData.uid);
                ...
                $scope.checkout = function () {
                    ...
                    var refCheckout = new Firebase("https://doanungdungweb.firebaseio.com/user/" + authData.uid + "/history");
                    var refOrder = new Firebase("https://doanungdungweb.firebaseio.com/order/" + authData.uid);
